  (function($){    
    ...
    $(function(){
        ...
        $(".view-services-list-inner .views-row").click(stop);
        max = rows().length;
        $(".view-services-list-inner a.prev").click(clickPrevious);
        $(".view-services-list-inner a.next").click(clickNext);
        $(".view-services-list-inner a.prev,.view-services-list-inner a.next").hide();
        ...
        function cloning()
        {
            ...
            $(".view-services-list-inner a.prev,.view-services-list-inner a.next").show();
            //start();
        }
        ...
        function createIndicators()
        {
            ...
            $(".view-services-list-inner .view-content").append($ul);
        }
    ...
    function container()
    {
        return $(".view-services-list-inner .view-content");
    }
    function rows()
    {
    ...
    function indicators()
    {
        return $(".view-services-list-inner .indicators li");
    }
